$(function () {
  ...
  const trackUrl = [
    "https://giufragiustino.github.io/audioplay/redux.mp3",
    "https://giufragiustino.github.io/audioplay/lemegeton.mp3",
    "https://giufragiustino.github.io/audioplay/telephone.mp3",
      "https://giufragiustino.github.io/audioplay/fame.mp3"
  ];
  ...
  function selectTrack(flag) {
    ...
    if (currIndex > -1 && currIndex < albumArtworks.length) {
      ...
      bgArtwork.css({ "background-color": "#191919" });
    } else {
      if (flag == 0 || flag == 1) --currIndex;
      else ++currIndex;
    }
